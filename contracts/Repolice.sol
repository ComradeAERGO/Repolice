...
import "@openzeppelin/contracts/access/Ownable.sol"; // Using OpenZeppelin's Ownable contract for basic authorization control

/// @title Voting Platform
/// @author Your Name
/// @notice This contract enables decentralized voting with additional features.
/// @dev This contract allows for the creation and participation in multiple polls, with added fee and emergency controls.
contract Repolice is Ownable {
    // Events
    ...
    function createPoll(string memory _question, string[] memory _options, uint256 _duration) public payable whenNotPaused {
    ...
    function changeVote(uint _pollId, uint _newOptionId) public payable whenNotPaused pollExists(_pollId) pollIsActive(_pollId) {
